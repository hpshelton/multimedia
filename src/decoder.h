...
public:
	...
	static QImage** read_pvc(QString filename, int* num_frames, bool CUDA);
	...
	static QImage** decompress_video(int** diff, int frames, mvec** vecArr, float compression, int height, int width, bool CUDA);
};
